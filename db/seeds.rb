...
#### == User == ####
user1 = User.first_or_initialize(email: "admin@gmail.com")
...
user2 = User.first_or_initialize(email: "coach1@gmail.com")
user2.password = "aaaaaaaa"
user2.nickname = "星野仙一"
user2.age = 40
user2.avatar = open("#{Rails.root}/db/data/usres/baseboll_coach.jpg")
...
user3 = User.first_or_initialize(email: "coach2@gmail.com")
user3.password = "aaaaaaaa"
user3.nickname = "為末大"
user3.age = 30
user3.avatar = open("#{Rails.root}/db/data/usres/track_coach.jpg")
...
user4 = User.first_or_initialize(email: "coach3@gmail.com")
user4.password = "aaaaaaaa"
user4.nickname = "松岡修造"
user4.age = 30
user4.avatar = open("#{Rails.root}/db/data/usres/tennis_coach.jpg")
...
user5 = User.first_or_initialize(email: "coach4@gmail.com")
user5.password = "aaaaaaaa"
user5.nickname = "ザッケローニ"
user5.age = 60
user5.avatar = open("#{Rails.root}/db/data/usres/soccer_coach.jpg")
...
user6 = User.first_or_initialize(email: "student1@gmail.com")
user6.password = "aaaaaaaa"
user6.nickname = "野球少年"
user6.age = 65
user6.avatar = open("#{Rails.root}/db/data/usres/baseboll_boy.jpg")
...
user7 = User.first_or_initialize(email: "student2@gmail.com")
user7.password = "aaaaaaaa"
user7.nickname = "陸上少年"
user7.age = 76
user7.avatar = open("#{Rails.root}/db/data/usres/track_boy.jpg")
...
user8 = User.first_or_initialize(email: "student3@gmail.com")
user8.password = "aaaaaaaa"
user8.nickname = "テニス少年"
user8.age = 87
user8.avatar = open("#{Rails.root}/db/data/usres/tennis_boy.jpg")
...
user9 = User.first_or_initialize(email: "student4@gmail.com")
user9.password = "aaaaaaaa"
user9.nickname = "サッカー少年"
user9.age = 98
user9.avatar = open("#{Rails.root}/db/data/usres/soccer_boy.jpg")
...
genre3 = Genre.first_or_create(name: "テニス")
genre4 = Genre.first_or_create(name: "サッカー")
